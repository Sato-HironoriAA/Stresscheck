...
?>
   ...
   function fnDocInterviewOK() {
     var obj = document.scheck_doctor;

     if (obj.rdoDocInterview.value)
     {
       if (window.confirm("医師面談指導の受否を設定します。\r\nよろしいですか？"))
       {
         obj.edit_mode.value = "1";
         obj.method = "post";
         obj.action = "scheck_doctor.php";
         obj.submit();
       }
     }
     else
...
?>
 ...
 <body bgcolor="#F9EFF1">
  <form name="scheck_doctor" method="post" action="" target="_top" onsubmit="return false;">
   <!--<div id="headerArea">-->
...
?>
   ...
   <table align="center" width="90%" border="0">
    <tr>
     <td>
      <font size="4"><p>医師の面接指導についての受否設定<br /><br />
             ＜あなたのストレスの程度について＞<br />
             &nbsp;&nbsp;&nbsp;高ストレス者に該当します。<br /><br />
             ＜面接指導の要否について＞<br />
...
?>
<!--
      <input type="radio" value="1" name="rdoDocInterview" <?php echo $checkedOK . $disabled; ?>>受けます。<br />
      （どちらかを選択）<br />
      <input type="radio" value="2" name="rdoDocInterview" <?php echo $checkedNG . $disabled; ?>>受けません。<br />
-->
      <input type="radio" value="1" name="rdoDocInterview" <?php echo $checkedOK . $disabled; ?>>受けます。
      （どちらかを選択）
      <input type="radio" value="2" name="rdoDocInterview" <?php echo $checkedNG . $disabled; ?>>受けません。<br />
      <br /></p></font>
     </td>
   ...
   <table align="center" id="headerTable" class="layout" width="95%" border=0 style="margin-left:50px;">
    ...
    <tr>
     <td align="left" nowrap>
      <input type="button" id="nodisButton" onclick="fnDocInterviewOK();" value="設定" <?php  echo $disButton . $disabled; ?>>
     </td>
    </tr>
   </table>
   </div>
